...
#' @name Table
#' @return A BranchGLMTable object.
...
#' @return A BranchGLMROC object.
#' @param ROC fastlogsiticROC object.
#' @export
...
#' Plotting ROC Curve
#' @description plot plots a ROC curve.
#' @param ROC A BranchGLMROC object.
...
#' @param lty Vector of linetypes used to create legend for ROC curves or a 
#' single linetype to be used for all ROC curves.
#' @param lwd Vector of linewidths used to create legend for ROC curves or a 
