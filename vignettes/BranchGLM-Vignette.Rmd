...
carsCat$mpg <- ifelse(carsCat$mpg > 15, 1, 0)

catFit <- BranchGLM(mpg ~ ., data = carsCat, family = "binomial", link = "logit")
...
probitFit <- BranchGLM(mpg ~ . ,data = carsCat, family = "binomial", 
                       link = "probit")

cloglogFit <- BranchGLM(mpg ~ . ,data = carsCat, family = "binomial", 
                       link = "cloglog")
