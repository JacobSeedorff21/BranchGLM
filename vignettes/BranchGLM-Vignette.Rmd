...
argument.
- If no initial values are specified, then the initial values are taken to be 0 
for the binomial and poisson families. The initial values for the gaussian and 
gamma families are estimated via linear regression with the response variable 
transformed by the link function.
